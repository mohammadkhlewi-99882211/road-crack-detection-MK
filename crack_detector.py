...
def refine_bbox(image_np, rough_bbox, expand=0.15):
    """
     هون دكتور هي الدالة هي اللي رح تشتغل مشان تطالع وتضمن انو الشرخ محاط بالكامل مشان نضمن انو الذكاء الاصطناعي 
     حتى لو اخطأ بالتقدير بحجم الشرخ وإحاطته رح تعطي الدالة هامش بيضمن وجود الاحاطة لكل الشق
    """
    ...
    # تحويل إلى إحداثيات الصورة الكاملة 
...
# ─────────────────────────────────────────────────────────────────────────────
"""
هون دكتور بالنسبة للدالة الاولى هي اللي بتقوم بعملية تحويل الصورة مشان نقلها
والثانية هي اللي بتشوف حجم الصورة اذا كبيرة بتصغرها مشان تصير عملية التحليل أسرع
وطبعا عملية التصغير بتضمن انو الشق ما بيتأثر
"""
# ─────────────────────────────────────────────────────────────────────────────
